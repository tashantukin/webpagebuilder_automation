...
WebUI.setText(findTestObject('staging_createPage/input_title'), GlobalVariable.title_merchant_buyer)

WebUI.setText(findTestObject('iframe_body'), GlobalVariable.Body)

WebUI.click(findTestObject('add_page/label_Publish'))

WebUI.click(findTestObject('add_page/label_Merchants and Registered Buyers'))
...
WebUI.setText(findTestObject('CONF_LINK/link'), GlobalVariable.url_link)
