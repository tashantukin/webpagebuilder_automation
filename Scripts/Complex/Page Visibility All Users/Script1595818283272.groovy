...
WebUI.setText(findTestObject('staging_createPage/input_title'), GlobalVariable.title_all_user)

WebUI.setText(findTestObject('iframe_body'), GlobalVariable.Body)

WebUI.click(findTestObject('add_page/label_Publish'))

WebUI.click(findTestObject('add_page/label_All users'))
...
WebUI.setText(findTestObject('CONF_LINK/link'), GlobalVariable.url_link_allusers)
